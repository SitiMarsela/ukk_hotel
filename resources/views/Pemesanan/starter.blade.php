    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">HOTEL STARBHAK <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/tampilanResepsionis">
...
<ul class="navbar-nav ml-auto">
    ...
    <!-- Nav Item - Alerts -->
    <a href="/logout"><h5 class="" style="padding-top: 20px">Logout</h5></a>
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small">DATA RESEPSIONIS</span>
        </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; HOTEL STARBHAK</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
